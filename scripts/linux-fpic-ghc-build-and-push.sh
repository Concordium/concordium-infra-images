...
aws s3 cp out/ghc-"$GHC_VERSION"-fpic-"$INTEGER_VARIANT"-x86_64-unknown-linux-gnu.tar.gz s3://static-libraries.concordium.com/fpic-ghc-test.tar.gz --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers
